...
function Registration() {
    ...
    const sendOtp = async () => {
        try {
          let url = 'http://localhost:8000/v1/sendOtp'
          let options = {
            method: 'POST',
            url: url,
            data: {
      ...
      const verifyEmail = async () => {
        try {
          let url = 'http://localhost:8000/v1/verifyOtp'
          let options = {
            method: 'POST',
            url: url,
            data: {
      ...
      //.......................................... End of email verification methods....................................
                ...
                <div className="container">
                    <div className="auth-main__row row">
                        ...
                        <div className="auth-main__row__right-col col-sm-6 col-12">
                                    ...
                                    <form action="#">
                                        ...
                                        <div className="sign-up__individual-section section-step sign-up-individual">
                                            ...
                                            <div className="splited-col">
                                                ...
                                                <label>
                                                    Last Name
                                                    <input type="text" id='ln' onChange={(e) => {
                                            ...
                                            <div
                                                onClick={() => {
                                                    if (valdiateForm(first, last, dob, gender, cnic, email, mobile, city, password, confirmPass) === true && (imgScore >= 0.70 && result == true) == true) { setPage(6); sendOtp(); }
                                                    else {
                                                        setPage(0)
                                                        setEmpty(true)
                                                    }
                            ...
                            {page === 6 ? <div style={{ height: "200px", width: "60%", backgroundColor: "#2575c0", margin: "13% 0% 0% 25%", borderRadius: "20px", padding: '5%' }}>
                                <h1 style={{ marginBottom: "3%", fontSize: "26px", color: "white", fontWeight: 'bold' }}>Email Verification</h1>
                                <input style={{ fontSize: "14px", width: "100%", borderRadius: '5px', fontWeight: '600' }} type="string" name='email' ref={codeRef} placeholder='Enter verification code' />
                                <button style={{
                                ...
                                <p style={{ marginTop: "3%", fontSize: "12px", color: "white", fontWeight: '600' }}>Note: An email with verification code has been send to you. Please check yor email account</p>
